...
class GadgetTest extends PHPUnit_Framework_TestCase
{
  ...
  {
      $this->Gadget->preloads = [0 => 'A', 1 => 'B'];

      $this->assertEquals([0 => 'A', 1 => 'B'], $this->Gadget->getPreloads());
  }
  ...
  {
      $this->Gadget->userPrefs = [0 => 'A', 1 => 'B'];

      $this->assertEquals([0 => 'A', 1 => 'B'], $this->Gadget->getUserPrefs());
  }
  ...
  {
      $this->Gadget->setPrefs([0 => 'A', 1 => 'B']);

      $this->assertEquals([0 => 'A', 1 => 'B'], $this->Gadget->getUserPrefValues());
  }
  ...
  public function testGetViews()
  {
      ...
      $this->assertEquals([0 => 'A', 1 => 'B'], $this->Gadget->getViews());
  }
