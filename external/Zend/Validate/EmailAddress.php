...
class Zend_Validate_EmailAddress extends Zend_Validate_Abstract
{
   ...
   * @var array
   */
  protected $_messageVariables = ['hostname' => '_hostname', 'localPart' => '_localPart'];
   ...
   *
   * @param bool $allowed Set allowed to true to validate for MX records, and false to not validate them
   */
