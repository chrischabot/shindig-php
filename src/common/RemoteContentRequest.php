...
class RemoteContentRequest
{
  ...
  {
      $this->createRemoteContentRequest('GET', $uri, null, null, self::getDefaultOptions());
  }
  ...
  {
      $this->createRemoteContentRequest('GET', $uri, $headers, null, self::getDefaultOptions());
  }
  ...
  {
      $this->createRemoteContentRequest('POST', $uri, null, $postBody, self::getDefaultOptions());
  }
  ...
  {
      $this->createRemoteContentRequest('POST', $uri, $headers, $postBody, self::getDefaultOptions());
  }
  ...
  {
      return $this->createFalseResponse(self::$SC_OK, $body, null);
  }
