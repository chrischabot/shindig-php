...
abstract class RequestItem
{
  ...
  public static $DEFAULT_START_INDEX = 0;
    ...
    public function getFields(array $defaultValue = [])
    {
        $result = [];
    ...
    abstract public function applyUrlTemplate($urlTemplate);

    abstract public function getParameter($paramName, $defaultValue = null);

    abstract public function getListParameter($paramName);
}
