...
{
    public static $HttpMethod = ['GET' => 'GET', 'POST' => 'POST'];
    public static $SignatureType = ['HMAC_SHA1' => 'HMAC_SHA1', 'RSA_SHA1' => 'RSA_SHA1',
      'PLAINTEXT'                             => 'PLAINTEXT', ];
    public static $KeyType = ['HMAC_SYMMETRIC' => 'HMAC_SYMMETRIC', 'RSA_PRIVATE' => 'RSA_PRIVATE'];
    public static $OAuthParamLocation = ['AUTH_HEADER' => 'auth_header', 'POST_BODY' => 'post_body',
      'URI_QUERY'                                    => 'uri_query', ];
}
